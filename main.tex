...
\supervisor{Dr. Efrén Mezura Montes} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Ing. Roides Javier Cruz Lara} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
